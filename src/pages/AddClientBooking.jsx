...
const AddClientBooking = () => {
  ...
  const retrieveAllUser = async () => {
    const response = await axios.get(
      "http://171.228.167.35:8080:8080/api/user/fetch/employees?role=Driver&status=Active"
    );
    return response.data;
  };
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post("http://171.228.167.35:8080:8080/api/transport/client/booking/add", formData)
      .then((resp) => {
